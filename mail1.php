...
$msg = "Имя: ".$_POST["name"]."<br>";$msg .= "Телефон: ".$_POST["phone"]."<br>";$msg .= "Email: ".$_POST["email"]."<br>";$msg .= "Время для связи: ".$_POST["time"]."<br>";$msg .= "Дата рождения: ".$_POST["date"]."<br>";$msg .= "Город проживания: ".$_POST["city"]."<br>";$msg .= "Номер паспорта: ".$_POST["num"]."<br>";$msg .= "Когда выдан: ".$_POST["when"]."<br>";$msg .= "Кем выдан: ".$_POST["who"]."<br>";$msg .= "Адрес прописки: ".$_POST["adress"]."<br>";
